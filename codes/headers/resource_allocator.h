#pragma once
#ifndef RESOURCES_ALLOCATOR_H
#define RESOURCES_ALLOCATOR_H
...
enum IMAGE {
  ...
  ONION, TOMATO, ONION_EFFECT, TOMATO_EFFECT, CAT, CAT_SCRATCH, COIN_HUD, DUST, BASE
};
