...
public:
	...
	enum IMAGE{PLAYER_IDLE, PLAYER_SE, PLAYER_NE, PLAYER_N, PLAYER_E, PLAYER_S, PLAYER_SGUN, MAINMENU_BG, MAINMENU_PLAY, MAINMENU_QUIT, MAINMENU_SETTING, CANNON_DIAGDOWN, CANNON_DIAGUP, CANNON_DOWN, CANNON_SIDE, CANNON_UP};
