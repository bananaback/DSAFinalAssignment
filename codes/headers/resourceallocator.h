...
public:
	...
	enum IMAGE{PLAYER_IDLE, PLAYER_SE, PLAYER_NE, PLAYER_N, PLAYER_E, PLAYER_S, PLAYER_SGUN, MAINMENU_BG, MAINMENU_PLAY,
		...
		SLIME_SIDE, CANNONBALL, EXPLOSION_BIG, EXPLOSION_SMALL,COIN_BIG, HEALTHBAR, HEALTHBAR_FILL, BOXWALL, GREENWALL, REDWALL, BLUEWALL, ICEWALL,
		SETTING_BG,CURSOR_1,CURSOR_2,CURSOR_3, CURSOR_4, CURSOR_5};
