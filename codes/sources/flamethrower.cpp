...
FlameThrower::FlameThrower(Game& game, float x, float y, float scale) : Weapon(game) {
	...
	//---------------------------------ADJUST HERE-------------------------------------------
	_textureSet.push_back(game.ra_ptr->_imageResources[IMAGE::FLAMETHROWER_UP]);
	_textureSet.push_back(game.ra_ptr->_imageResources[IMAGE::FLAMETHROWER_DIAGUP]);
	_textureSet.push_back(game.ra_ptr->_imageResources[IMAGE::FLAMETHROWER_SIDE]);
	_textureSet.push_back(game.ra_ptr->_imageResources[IMAGE::FLAMETHROWER_DIAGDOWN]);
	_textureSet.push_back(game.ra_ptr->_imageResources[IMAGE::FLAMETHROWER_DOWN]);
	_radius = 30;
	//---------------------------------------------------------------------------------------
	for (int i = 0; i <= 8; i++) {
